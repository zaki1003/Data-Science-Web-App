...
st.markdown("This application is a Streamlit dashboard that can be used to analyse motor vehicule collisions in NYC")
...
injured_people = st.slider("Number of persons injured in vehicule collisions",0,19)
...
c1 = data['injured_pedestrians'][:100]
c2 = data['injured_cyclists'][:100]
c3 = data['injured_motorists'][:100]
